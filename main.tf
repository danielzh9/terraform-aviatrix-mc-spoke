...
resource "aviatrix_spoke_gateway" "default" {
  ...
  ha_availability_domain                = var.ha_gw ? (local.cloud == "oci" ? (aviatrix_vpc.default[0].region == "us-sanjose-1" ? aviatrix_vpc.default[0].availability_domains[1] : aviatrix_vpc.default[0].availability_domains[0]) : null) : null
